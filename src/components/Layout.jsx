import { Outlet,Link,useLocation } from "react-router-dom" //contenedor dinamico mantiene la aparienca en cada unos de los componentes
...
// el pathname te reporta la ubicacion en donde estamos
  return (
